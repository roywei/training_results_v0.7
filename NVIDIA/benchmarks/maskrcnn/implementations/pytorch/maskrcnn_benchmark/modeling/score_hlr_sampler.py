...
class ScoreHLRSampler(object):
    ...
    def __call__(self, matched_idxs,  regression_targets, prop_boxes,image_sizes,
                 features, feature_extractor, predictor, box_coder, is_rpn=0, objectness=None):
        """
        Arguments:
            ...
            for matched_idxs_per_image in matched_idxs:
                ...
                if num_valid > 0:
                    ...
                    pred_bboxes = box_coder.decode(
                         selected_bbox_pred, valid_rois[:, 1:])
                ...
                return pos_idx, negative[select_inds], neg_label_weights
