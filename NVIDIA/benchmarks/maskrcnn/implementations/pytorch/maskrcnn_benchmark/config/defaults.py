...
_C.MODEL.ROI_BOX_HEAD.GIOU_BOX_WEIGHT = 10.0
_C.MODEL.ROI_BOX_HEAD.GIOU_CARL_WEIGHT = 10.0
_C.MODEL.ROI_BOX_HEAD.CARL = False
_C.MODEL.ROI_BOX_HEAD.ISR_P = False
_C.MODEL.ROI_BOX_HEAD.ISR_N = False
_C.MODEL.ROI_BOX_HEAD.K = 0.5
_C.MODEL.ROI_BOX_HEAD.BIAS = 0.0
_C.MODEL.ROI_BOX_HEAD.SCORE_THRESHOLD = 0.05
_C.MODEL.ROI_BOX_HEAD.IOU_THRESHOLD = 0.5
_C.MODEL.ROI_BOX_HEAD.PISA_ONEPASS = True
