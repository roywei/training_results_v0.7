...
_C.MODEL.ROI_HEADS.K = 0.5
_C.MODEL.ROI_HEADS.BIAS = 0.0
_C.MODEL.ROI_HEADS.SCORE_THRESHOLD = 0.05
_C.MODEL.ROI_HEADS.IOU_THRESHOLD = 0.5
_C.MODEL.ROI_HEADS.PISA_ONEPASS = True
